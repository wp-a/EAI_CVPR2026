...
| V-AS | `scripts/run_vas_v6_repro.sh` | Use `RUN_INFERENCE=1` in the clean bundle to regenerate raw candidates from bundled models; use `RUN_INFERENCE=0` only when cached raw candidates are present. |
